...
public class SmokeGrenadeItem extends Item implements ProjectileItem {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            SmokeGrenadeEntity smokeBombEntity = new SmokeGrenadeEntity(world, user);
    ...
    public ProjectileEntity createEntity(World world, Position pos, ItemStack stack, Direction direction) {
        SmokeGrenadeEntity smokeBombEntity = new SmokeGrenadeEntity(world, pos.getX(), pos.getY(), pos.getZ());
